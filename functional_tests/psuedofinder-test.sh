...
this_program_name="psuedofinder-test.sh"
...
${this_program_name}: run integration/regression tests for psuedofinder 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/psuedofinder -d data/tests
